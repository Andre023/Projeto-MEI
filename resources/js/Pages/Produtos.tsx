    ...
    <AuthenticatedLayout>
      ...
      <div className="py-12 bg-gray-100 dark:bg-gray-900 min-h-screen transition-colors duration-300">
        <div className="w-full mx-auto px-4 sm:px-6 lg:px-8 space-y-4">
          ...
          `}>
            {/* 4. Container de filtros escuro */}
            <div className="p-4 bg-white dark:bg-gray-800 shadow-sm sm:rounded-lg space-y-4 border border-gray-200 dark:border-gray-700">
              <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-4">

                {/* Coluna 1 */}
                <div className="space-y-4">
                  <div>
                    <label htmlFor="filtro_cat" className="block text-sm font-medium text-gray-700 dark:text-gray-300">Categoria</label>
                    <select
                      id="filtro_cat"
                  ...
                  <div>
                    <label htmlFor="filtro_sub" className="block text-sm font-medium text-gray-700 dark:text-gray-300">Subcategoria</label>
                    <select
                      id="filtro_sub"
                      value={selectedSubcategoriaId}
                      onChange={handleSubcategoriaChange}
                      disabled={!selectedCategoriaId || subcategoriaOptions.length === 0}
                      className="mt-1 block w-full border-gray-300 rounded-md shadow-sm focus:border-indigo-500 focus:ring-indigo-500 disabled:bg-gray-100 
                                 dark:bg-gray-900 dark:border-gray-600 dark:text-gray-100 dark:disabled:bg-gray-800 dark:disabled:text-gray-500"
                    >
                ...
                <div className="space-y-4">
                  <div>
                    <label htmlFor="filtro_grp" className="block text-sm font-medium text-gray-700 dark:text-gray-300">Grupo</label>
                    <select
                      id="filtro_grp"
                  ...
                  <div>
                    <label htmlFor="filtro_subgrp" className="block text-sm font-medium text-gray-700 dark:text-gray-300">Subgrupo</label>
                    <select
                      id="filtro_subgrp"
                ...
                <div className="space-y-4">
                  <div>
                    <label htmlFor="filtro_preco_min" className="block text-sm font-medium text-gray-700 dark:text-gray-300">Preço (Mín)</label>
                    <input
                      type="number"
                      id="filtro_preco_min"
                      value={precoMin}
                      ...
                      placeholder="R$ 0,00"
                      className="mt-1 block w-full border-gray-300 rounded-md shadow-sm focus:border-indigo-500 focus:ring-indigo-500
                                 dark:bg-gray-900 dark:border-gray-600 dark:text-gray-100 dark:placeholder-gray-500"
                    />
                  </div>
                  <div>
                    <label htmlFor="filtro_preco_max" className="block text-sm font-medium text-gray-700 dark:text-gray-300">Preço (Máx)</label>
                    <input
                      type="number"
                      id="filtro_preco_max"
                      value={precoMax}
                ...
                <div className="space-y-4">
                  <div>
                    <span className="block text-sm font-medium text-gray-700 dark:text-gray-300">Outros</span>
                    <div className="mt-2 flex items-center">
                      ...
                      />
                      <label htmlFor="filtro_estoque" className="ml-2 block text-sm text-gray-900 dark:text-gray-300">
          ...
          <div className="md:hidden space-y-4">
            ...
            {!isLoading && produtos.map((produto) => (
              // 5. Card mobile escuro
              <div key={produto.id} className="p-4 bg-white dark:bg-gray-800 shadow rounded-lg space-y-3 border border-gray-100 dark:border-gray-700">
                <div className="flex justify-between items-start gap-2">
                  <span className="font-medium text-gray-900 dark:text-white break-words">
                    {produto.nome}
                  </span>
                  <span className="text-sm text-gray-600 dark:text-gray-400 font-mono ml-2 flex-shrink-0">
                    ID: {produto.id}
                  </span>
                </div>
                ...
                <div className="flex justify-between items-center text-sm">
                  ...
                  {produto.codigo && (
                    <div>
                      ...
                      <span className="text-gray-700 dark:text-gray-300">{produto.codigo}</span>
                    </div>
                  )}
                </div>
                <div className="text-sm">
                  <span className="text-gray-500 dark:text-gray-400">Árvore: </span>
                  <span className="text-gray-700 dark:text-gray-300 break-words">
                    {formatSubgrupoPath(produto)}
                  </span>
                </div>
                <div className="flex items-center justify-end space-x-1 pt-3 mt-3 border-t border-gray-100 dark:border-gray-700">
                  <button
                    onClick={() => {
                      setProdutoHistorico(produto);
                      setIsHistoricoModalOpen(true);
                    }}
                    className="p-2 rounded-full text-gray-500 dark:text-gray-400 hover:bg-gray-100 dark:hover:bg-gray-700 transition duration-150"
                  ...
                  <button
                    ...
                    className="p-2 rounded-full text-cyan-600 dark:text-cyan-400 hover:bg-cyan-100 dark:hover:bg-cyan-900/30 transition duration-150"
                  ...
                  <button
                    ...
                    className="p-2 rounded-full text-yellow-600 dark:text-yellow-400 hover:bg-yellow-100 dark:hover:bg-yellow-900/30 transition duration-150"
                  ...
                  <button
                    ...
                    className="p-2 rounded-full text-red-600 dark:text-red-400 hover:bg-red-100 dark:hover:bg-red-900/30 transition duration-150"
          ...
          {/* --- TABELA DESKTOP --- */}
          <div className="hidden md:block overflow-x-auto min-h-[500px] bg-white dark:bg-gray-800 rounded-lg shadow border border-gray-200 dark:border-gray-700">
            <table className="min-w-full divide-y divide-gray-200 dark:divide-gray-700">
              ...
              <thead className="bg-gray-700 dark:bg-gray-900">
                <tr>
                  ...
                  <th onClick={() => handleSort("preco_de_custo")} className="px-6 py-3 text-center text-xs font-medium text-gray-100 uppercase tracking-wider cursor-pointer">
                    Custo {getSortIcon("preco_de_custo")}
                  </th>
              ...
              <tbody className="bg-white dark:bg-gray-800 divide-y divide-gray-200 dark:divide-gray-700">
                {!isLoading && produtos.map((produto) => (
                  <tr key={produto.id} className="hover:bg-gray-50 dark:hover:bg-gray-700 transition-colors">
                    <td className="px-6 py-4 whitespace-nowrap text-sm text-gray-900 dark:text-gray-200 text-center">{produto.id}</td>

                    <td className="px-6 py-4 text-sm font-medium text-gray-900 dark:text-white text-left max-w-sm truncate" title={produto.nome}>
                      {produto.nome}
                    </td>

                    <td className="px-6 py-4 whitespace-nowrap text-sm text-gray-500 dark:text-gray-400 text-center hidden lg:table-cell">{produto.codigo || "N/A"}</td>
                    <td className="px-6 py-4 whitespace-nowrap text-sm text-gray-700 dark:text-gray-300 text-center">
                      {formatCurrency(produto.preco_de_custo)}
                    </td>
                    <td className="px-6 py-4 whitespace-nowrap text-sm text-gray-900 dark:text-white font-semibold text-center">
                      {formatCurrency(produto.preco)}
                    </td>
                    <td className="px-6 py-4 whitespace-nowrap text-sm text-gray-900 dark:text-white font-bold text-center">{produto.quantidade_estoque ?? 0}</td>

                    <td className="px-6 py-4 text-sm text-gray-500 dark:text-gray-400 max-w-60 truncate text-center hidden lg:table-cell" title={formatSubgrupoPath(produto)}>
                      {formatSubgrupoPath(produto)}
                    </td>
          ...
          {/* 8. Paginação Escura */}
          {totalItems > 0 && (
            <div className="flex flex-col sm:flex-row justify-between items-center p-4 border-t border-gray-200 dark:border-gray-700 gap-4 bg-white dark:bg-gray-800 rounded-b-lg">
              <div className="flex flex-wrap items-center gap-3 text-sm text-gray-700 dark:text-gray-300">
                <div className="flex items-center gap-2 bg-gray-50 dark:bg-gray-700 border border-gray-300 dark:border-gray-600 rounded-lg px-3 py-1.5">
                  <label htmlFor="itemsPerPageSelect" className="font-medium whitespace-nowrap">
                    Itens por página:
                  </label>
                  <div className="relative">
                    <select
                      ...
                      className="appearance-none border border-gray-300 dark:border-gray-500 rounded-md pl-3 pr-8 py-1.5 bg-white dark:bg-gray-800 text-gray-900 dark:text-gray-100 focus:ring-2 focus:ring-blue-500 focus:border-blue-500 outline-none cursor-pointer"
                    >
